...
// =============================================================================
// Artifact Types (Agent → Sidebar, streaming wire protocol)
// =============================================================================

/// An artifact created by the agent (HTML, code, document, etc.)
///
/// This is the complete, non-streaming representation. For streaming delivery
/// the agent uses [`ArtifactStart`], [`ArtifactDelta`], and [`ArtifactComplete`].
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct Artifact {
...
/// Sent when an artifact begins streaming (Agent → Sidebar).
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
...
/// A chunk of artifact content (Agent → Sidebar, streaming).
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
...
/// Sent when artifact streaming is complete (Agent → Sidebar).
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
